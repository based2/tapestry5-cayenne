...
public class TestUtils {
    ...
    /**
     * Initializes a database for tests. Note that this will drop tables, as
     * well as create new ones.
     * 
     * @param dbadapter
     * @See com.googlecode.tapestry5cayenne.CayenneDBAdapter
     * @throws Exception
     */
	...
	DbAdapter adapter = CayenneDBAdapter.get(CayenneDBAdapter.H2);
	    ...
	    DbGenerator dbgen = new DbGenerator(adapter, map);
	...
	TapestryAppInitializer initializer = new TapestryAppInitializer(logger,
		provider, appName, PageTesterModule.TEST_MODE);
