...
public class TapestryCayenneCoreModule {
    ...
    public static CayenneDBAdapter cayenneDBAdapter = CayenneDBAdapter.HSQLDB;
    // private static CayenneDBAdapter cayenneDBAdapter = CayenneDBAdapter.H2;

    public static DbAdapter getDB() throws InstantiationException,
	    IllegalAccessException
    {
	return CayenneDBAdapter.get(TapestryCayenneCoreModule.cayenneDBAdapter);
    }
    ...
    public static void contributeValueEncoderSource(
	    @SuppressWarnings("rawtypes") MappedConfiguration<Class, ValueEncoderFactory> configuration,
    ...
    public static void contributeTypeCoercer(
	    @SuppressWarnings("rawtypes") Configuration<CoercionTuple> conf)
    {
	...
	conf.add(new CoercionTuple<Query, List>(Query.class, List.class,
		new Coercion<Query, List>()
		{
    ...
    {
	// If logging is enabled, we want logging to be the first advice,
	// wrapping around the commit advice.

	configuration.addInstance("CommitAfter",
		CayenneCommitAfterWorker.class,
		"after:Log");
    }
